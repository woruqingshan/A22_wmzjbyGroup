...
DEFAULT_MODEL_CACHE="$(ls -d "${HOME}"/.cache/huggingface/hub/models--Qwen--Qwen3-ASR-0.6B/snapshots/* 2>/dev/null | head -n 1 || true)"
...
export ASR_MAX_NEW_TOKENS="${ASR_MAX_NEW_TOKENS:-512}"
export ASR_MAX_INFERENCE_BATCH_SIZE="${ASR_MAX_INFERENCE_BATCH_SIZE:-8}"
